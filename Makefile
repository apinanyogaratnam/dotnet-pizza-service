...
tag:
	docker tag dotnet-service ghcr.io/apinanyogaratnam/dotnet-pizza-service:${TAG_VERSION}
	git tag -m "v${TAG_VERSION}" v${TAG_VERSION}

push:
	docker push ghcr.io/apinanyogaratnam/dotnet-pizza-service:${TAG_VERSION}
	git push --tags
